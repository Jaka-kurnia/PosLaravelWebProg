  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                        <div
                            class="bg-gradient-to-br from-brand-500 to-orange-600 p-5 rounded-2xl border border-white/20 shadow-lg shadow-orange-100 relative overflow-hidden group hover:shadow-xl transition-all">
